...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between px-6 py-5 border-b border-gray-100 gap-4">
        ...
        <div class="flex-1 w-full lg:max-w-2xl mx-0 lg:mx-4">
            <form action="{{ route('transactions.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="w-full sm:w-32">
                    <select name="year" onchange="this.form.submit()" 
                            class="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white">
        ...
        <div class="flex flex-wrap items-center gap-2 flex-shrink-0 w-full lg:w-auto mt-2 lg:mt-0">
            <div class="flex items-center gap-2">
                <a href="{{ route('transactions.export.csv', request()->all()) }}" target="_blank"
                ...
                <a href="{{ route('transactions.export.excel', request()->all()) }}" target="_blank"
