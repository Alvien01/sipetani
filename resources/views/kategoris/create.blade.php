...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 max-w-2xl mx-auto">
    <form action="{{ route('kategoris.store') }}" method="POST" class="p-6">
        @csrf
        <div class="space-y-4">
            <div>
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-green-700 hover:bg-green-800 rounded-xl transition-colors shadow-sm">Simpan</button>
        </div>
    </form>
</div>
@endsection
