                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-emerald-600 border border-emerald-600 cursor-default leading-5 rounded-md shadow-sm z-10">{{ $page }}</span>
                                    </span>
                                @else
                                    <a href="{{ $url }}" class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-emerald-700 hover:bg-emerald-50 focus:outline-none focus:ring ring-emerald-100 focus:border-emerald-500 active:bg-emerald-100 active:text-emerald-800 transition ease-in-out duration-150 rounded-md" aria-label="{{ __('Go to page :page', ['page' => $page]) }}">
                                        {{ $page }}
                                    </a>
                                @endif
                            @endforeach
