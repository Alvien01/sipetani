    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform transition-all scale-100">
        <div class="p-6">
            <div class="flex items-center justify-between mb-5">
                <h3 class="text-lg font-bold text-gray-900">Import Produk</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-center gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <a href="{{ route('products.template.csv') }}" class="text-xs text-blue-600 hover:text-blue-800 hover:underline">Download Template CSV</a>
                        </div>
                    </div>
                </div>
