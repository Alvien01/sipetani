...
<div class="">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('personels.update', $personel) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $personel->name) }}" required
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $personel->email) }}" required
                ...
                <div>
                    ...
                    <input type="tel" name="phone" value="{{ old('phone', $personel->phone) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nrp" value="{{ old('nrp', $personel->nrp) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="rank" value="{{ old('rank', $personel->rank) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position', $personel->position) }}" required
                ...
                <div>
                    ...
                    <select name="role_id" required
                        ...
                        <option value="{{ $role->id }}" {{ old('role_id', $personel->role_id) == $role->id ? 'selected' : '' }}>
                            {{ $role->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="status" required
                        ...
                        <option value="Tersedia" {{ old('status', $personel->status) == 'Tersedia' ? 'selected' : '' }}>Tersedia</option>
                        <option value="Siaga" {{ old('status', $personel->status) == 'Siaga' ? 'selected' : '' }}>Siaga</option>
                        <option value="Terkonfirmasi" {{ old('status', $personel->status) == 'Terkonfirmasi' ? 'selected' : '' }}>Terkonfirmasi</option>
                    </select>
                    @error('status')
                    <p class="mt-1 text-sm text-green-600">{{ $message }}</p>
                    @enderror
